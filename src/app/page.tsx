...
function FeaturesSection() {
  const features = [
    { icon: I.shield, t: "확실한 신원보장", d: "재직증명서, 혼인관계증명서, 신분증 등 꼼꼼한 서류검토", color: "#e8457f" },
...
function FAQSection() {
  const fqs = [
    { q: "어떤 서류를 제출해야 하나요?", a: "재직증명서, 혼인관계증명서, 신분증 등을 기본으로 요청드립니다. 서류는 매칭 목적 외 절대 사용되지 않으며, 종료 후 안전하게 폐기됩니다." },
