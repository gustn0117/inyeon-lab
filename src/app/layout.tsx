...
export const metadata: Metadata = {
  ...
  description:
    "앱이 아닌 수도권 중심 1:1 연애정보회사. 가입비 없이 시작해 양측 매칭 성사 후 결제하며, 공개된 금액으로 실제 대면 소개팅까지 연결합니다.",
  keywords: "1:1 연애정보회사, 수도권 소개팅, 소개팅, 인연매칭, 매칭 후 결제, 가입비 없는 소개팅, 대면 소개팅, 인연연구소",
  metadataBase: new URL("https://inyeon.today"),
  openGraph: {
    title: "인연연구소 | 가입비 없이 매칭 후 결제하는 대면 소개팅",
    description: "앱이 아닌 수도권 중심 1:1 연애정보회사. 가입비 없이 시작해 양측 매칭 성사 후 결제하고 실제 대면 소개팅까지 연결합니다.",
