      ...
      <div className="container-apple relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6 reveal">
          ...
          <article className="card-neon card-rainbow relative overflow-hidden min-h-[460px] text-white">
            ...
            <div className="absolute -bottom-20 -left-20 w-56 h-56 rounded-full blur-3xl" style={{ background: "rgba(255,141,168,0.55)" }} />
          ...
          {/* 메인 카드 2 - 밝은 핑크 */}
          <article className="card-neon card-rainbow text-ink rounded-3xl relative overflow-hidden p-10 sm:p-14 min-h-[460px] flex flex-col justify-between"
            style={{ background: "linear-gradient(135deg, #fff5f8 0%, #ffe8ef 50%, #ffd6e4 100%)" }}>
            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full blur-3xl" style={{ background: "rgba(255,179,200,0.7)" }} />
            <div className="absolute -bottom-24 -left-20 w-72 h-72 rounded-full blur-3xl" style={{ background: "rgba(255,141,168,0.5)" }} />
            <div className="absolute top-1/2 left-1/2 w-48 h-48 rounded-full blur-3xl" style={{ background: "rgba(251,113,133,0.3)" }} />
