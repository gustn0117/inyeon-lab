  ...
  if (variant === "pill") {
    return (
      <button
        type="button"
        onClick={copy}
        className={`inline-flex min-h-11 items-center gap-2 border border-[#234652] bg-[#102A35] px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-[#087A9B] ${className}`}
      >
