...
export default function KakaoFlow() {
  return (
    <section className="py-20 sm:py-28 lg:py-32 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #fff8f3, #fff0f5)" }}>
        ...
        <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-8 lg:gap-12 items-center reveal">
          ...
          <div className="space-y-5 order-2 lg:order-1">
            {[
              ...
              { n: "03", t: "회원 추천", d: "조건에 맞는 검증된 회원을 1:1 비공개로 추천드려요." },
