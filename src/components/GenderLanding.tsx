...
const CONTENT = {
  women: {
    ...
    lead: "수도권을 중심으로 진행합니다. 가입비는 0원, 이용권은 1회권 33,000원입니다. 첫 프로필 전달일부터 30일 동안 횟수 제한 없이 프로필을 받아보실 수 있어요.",
    price: "1회권 33,000원",
    priceLabel: "첫 프로필 전달 후 30일 · 횟수 제한 없음",
    costLine: "가입비 0원 · 1회권 33,000원 (첫 프로필 전달 후 30일 유효)",
    condition: "한국나이 기준 1988년생까지의 미혼 여성만 신청 가능",
    heroImage: "/inyeon-2026/male-01-v4.webp",
    heroImageClass: styles.heroImageWomen,
    highlights: ["가입비 0원", "1회권 33,000원", "30일 횟수 제한 없는 프로필", "대면 소개팅"],
    ...
    poolPoints: [
      ...
      { title: "기본 조건 확인", body: "생활권·연령 등 기본 조건을 확인해 제안합니다." },
    ],
    promiseTitle: "좋은 만남에 필요한 기준은 분명하게",
    promiseLead: "담당자가 기본 조건과 소개 의사를 확인하고, 30일 동안 횟수 제한 없이 프로필을 제안합니다.",
    criteriaTitle: "여성 회원에게 유리한 이용 방식",
    criteria: ["신원 확인", "20·30대 중심", "30일 횟수 제한 없는 제안", "미혼 회원"],
    promises: [
      ...
      { title: "30일간 이어지는 제안", body: "1회권 33,000원으로 시작하면 첫 프로필 전달일부터 30일 동안 횟수 제한 없이 프로필을 제안드립니다." },
    ],
    preferenceSummary: "생활권·연령 등 기본 조건을 확인한 뒤 30일간 제안",
    steps: [
      { number: "01", title: "기본 정보 신청", body: "연락처·지역·출생연도·직업·키만 간단히 남깁니다. 신청은 0원입니다." },
      { number: "02", title: "기본 조건 확인", body: "담당자가 생활권·연령 등 기본 조건과 소개 의사를 확인합니다." },
      { number: "03", title: "1회권 시작", body: "진행을 원하시면 1회권 33,000원을 결제하고 첫 프로필을 받습니다." },
      { number: "04", title: "30일 프로필 제안", body: "첫 프로필 전달일부터 30일 동안 횟수 제한 없이 프로필을 제안드립니다." },
      { number: "05", title: "양측 동의 후 대면 조율", body: "두 분 모두 원할 때만 매칭이 성사되고, 담당자가 날짜와 장소를 조율합니다." },
    ],
    applicationLead: "신청과 상담은 0원입니다. 기본 정보만 남기면 담당 매칭사가 확인 후 연락드리고, 진행을 원하실 때 1회권 33,000원으로 시작합니다.",
    faqs: [
      { question: "신청하면 바로 결제하나요?", answer: "아니요. 신청과 상담은 0원입니다. 진행을 원하실 때 1회권 33,000원을 결제하면, 첫 프로필 전달일부터 30일 동안 횟수 제한 없이 프로필을 받아보실 수 있어요." },
      { question: "1회권은 언제까지 쓸 수 있나요?", answer: "최초 프로필 전달일부터 30일 동안 유효하며, 기간 내에는 프로필 제안 횟수에 제한이 없습니다." },
      { question: "남성과 이용 방식이 왜 다른가요?", answer: "여성은 시작 시 결제하는 대신 30일 동안 횟수 제한 없이 프로필을 받고, 남성은 제안 횟수가 정해진 대신 매칭이 성사된 뒤에 결제합니다. 각자에게 유리한 방식으로 설계했습니다." },
    ...
    stickyLabel: "가입비 0원 · 1회권 33,000원",
  },
  men: {
    kicker: "1:1 연애정보회사 · 남성 안내",
    title: <>여성 회원이 더 많은,<br /><span className={styles.lemonMark}>1:1 대면 소개팅</span></>,
    lead: "수도권을 중심으로 진행합니다. 가입비는 0원, 이용권은 1회권 44,000원입니다. 실제로 여성 회원 비중이 높아 소개 흐름이 원활합니다.",
    price: "1회권 44,000원",
    priceLabel: "매칭 성사 시점에 결제",
    costLine: "가입비 0원 · 1회권 44,000원 (매칭 성사 시점에 결제)",
    condition: "한국나이 기준 1984년생까지의 미혼 남성만 신청 가능",
    heroImage: "/inyeon-2026/female-01-v4.webp",
    heroImageClass: styles.heroImageMen,
    highlights: ["가입비 0원", "1회권 44,000원", "여성 비중 높은 회원풀", "대면 소개팅"],
    poolKicker: "CURATED WOMEN'S POOL",
    poolTitle: "여성 비중이 높은, 소개 가능한 여성 회원풀",
    poolLead: "막연한 랜덤 소개가 아닙니다. 실제로 남성보다 여성 회원 비중이 높고, 현재 소개 가능한 상태와 성비 균형을 함께 관리하며 생활권·연령 등 기본 조건을 확인해 프로필을 제안합니다.",
    poolImages: [
      { src: "/inyeon-2026/female-02-v4.webp", label: "여성 비중 높은 회원풀" },
      { src: "/inyeon-2026/female-03-v4.webp", label: "기본 조건 확인 후 제안" },
      { src: "/inyeon-2026/female-04-v4.webp", label: "현재 소개 가능 상태 확인" },
    ],
    poolPoints: [
      { title: "성비 밸런스", body: "실제로 여성 회원 비중이 높아 소개 흐름이 원활합니다." },
      { title: "기본 조건 확인", body: "생활권·연령 등 기본 조건을 확인해 제안합니다." },
    ...
    criteriaTitle: "남성 회원에게 유리한 이용 방식",
    criteria: ["기본 조건 확인", "여성 비중 높은 회원풀", "상호 프로필 동의", "미혼 회원"],
    promises: [
      { title: "매칭 성사 후 결제", body: "가입비는 0원입니다. 1회권 44,000원은 두 분 모두 동의해 매칭이 성사된 시점에 결제합니다. 1회권의 프로필 제안 횟수는 정해져 있습니다." },
      { title: "대면 소개팅 보장", body: "연락처만 전달하고 끝내지 않습니다. 담당자가 실제 만남 날짜와 장소를 조율해 소개팅으로 연결합니다." },
      { title: "신원 확인된 회원", body: "미혼 여부 등 기본 신원을 확인한 회원 중 기본 조건을 확인해 제안합니다." },
    ],
    preferenceSummary: "생활권·연령 등 기본 조건을 확인한 뒤 정해진 횟수 안에서 제안",
    steps: [
      { number: "01", title: "기본 정보 신청", body: "연락처·지역·출생연도·직업·키만 간단히 남깁니다. 신청은 0원입니다." },
      { number: "02", title: "기본 조건 확인", body: "담당자가 생활권·연령 등 기본 조건과 소개 의사를 확인합니다." },
      { number: "03", title: "프로필 제안", body: "정해진 횟수 안에서 여성 회원의 프로필을 제안드립니다." },
      { number: "04", title: "양측 소개 의사 확인", body: "한쪽만 마음에 든다고 성사되지 않습니다. 두 분 모두 원할 때만 다음 단계로 갑니다." },
      { number: "05", title: "성사 시점 결제 후 대면 조율", body: "매칭이 성사된 시점에 1회권 44,000원을 결제하고, 담당자가 날짜와 장소를 조율합니다." },
    ],
    applicationLead: "매칭이 성사되기 전까지 비용은 0원입니다. 기본 정보만 남기면 담당 매칭사가 기본 조건을 확인하고, 매칭 성사 시점에 1회권 44,000원을 안내합니다.",
    faqs: [
      { question: "신청하면 바로 결제하나요?", answer: "아니요. 가입비는 0원이며, 정해진 횟수 안에서 프로필을 제안받고 두 분 모두 소개를 원해 매칭이 성사된 시점에 1회권 44,000원을 결제합니다." },
      { question: "프로필은 몇 번 제안받나요?", answer: "1회권에 포함된 프로필 제안 횟수는 정해져 있으며, 자세한 횟수는 상담에서 안내드립니다." },
      { question: "여성과 이용 방식이 왜 다른가요?", answer: "남성은 매칭이 성사된 뒤에만 결제하는 대신 제안 횟수가 정해져 있고, 여성은 시작 시 결제하는 대신 30일 동안 횟수 제한 없이 프로필을 받습니다. 각자에게 유리한 방식으로 설계했습니다." },
      { question: "어떤 상태가 ‘매칭 성사’인가요?", answer: "담당자가 제안한 프로필을 서로 확인한 뒤, 두 분 모두 실제로 만나보겠다고 동의한 상태를 뜻합니다." },
      { question: "카톡으로만 연결되고 끝나나요?", answer: "아니요. 연락처만 전달하고 끝내지 않습니다. 양측 동의 후 담당자가 날짜와 장소를 조율해 실제 대면 소개팅까지 안내합니다." },
      { question: "실회원만 소개하나요?", answer: "네. 인연연구소는 100% 실제 소개 의사가 확인된 실회원으로 진행합니다." },
    ],
    stickyLabel: "가입비 0원 · 1회권 44,000원",
  },
} as const;
