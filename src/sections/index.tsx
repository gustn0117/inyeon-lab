...
/* ═══ IDEAL MATCH — glass card CTA (페이지 캔버스 위) ═══ */
...
export function PromiseSection() {
  const promises = [
    ...
    },
    {
      icon: I.users,
      t: "서류로 검증된 실회원 매칭입니다",
      d: "재직증명서, 혼인관계증명서 등으로 신원이 확인된 100% 실회원과만 매칭됩니다. 자동 응답 프로필로 소개를 진행하지 않습니다.",
    },
    {
      icon: I.heart,
      t: "한 분 한 분 정성으로",
      ...
      <div className="container-apple">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-8 border-t border-pink-100">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <span className="text-sm font-bold text-ink">@inyeon_lab</span>
            <span className="w-1 h-1 rounded-full bg-ink-tertiary/50" />
            <a href="tel:01076170181" className="text-sm font-bold text-ink hover:text-accent transition-colors">
              010-7617-0181
            </a>
          </div>
        ...
        <p className="sr-only">
          인연연구소 소개팅 서비스 지역: 강릉 동해 삼척 속초 원주 춘천 태백 고양 과천 광명 광주 구리 군포 김포 남양주 동두천 부천 성남 수원 시흥 안산 안성 안양 양주 여주 오산 용인 의왕 의정부 이천 파주 평택 포천 하남 화성 거제 김해 밀양 사천 양산 진주 창원 통영 경산 경주 구미 김천 문경 상주 안동 영주 영천 포항 광양 나주 목포 순천 여수 군산 김제 남원 익산 전주 정읍 계룡 공주 논산 당진 보령 서산 아산 천안 제천 청주 충주.
          지역별 소개팅 키워드: 강릉소개팅 동해소개팅 삼척소개팅 속초소개팅 원주소개팅 춘천소개팅 태백소개팅 고양소개팅 과천소개팅 광명소개팅 광주소개팅 구리소개팅 군포소개팅 김포소개팅 남양주소개팅 동두천소개팅 부천소개팅 성남소개팅 수원소개팅 시흥소개팅 안산소개팅 안성소개팅 안양소개팅 양주소개팅 여주소개팅 오산소개팅 용인소개팅 의왕소개팅 의정부소개팅 이천소개팅 파주소개팅 평택소개팅 포천소개팅 하남소개팅 화성소개팅 거제소개팅 김해소개팅 밀양소개팅 사천소개팅 양산소개팅 진주소개팅 창원소개팅 통영소개팅 경산소개팅 경주소개팅 구미소개팅 김천소개팅 문경소개팅 상주소개팅 안동소개팅 영주소개팅 영천소개팅 포항소개팅 광양소개팅 나주소개팅 목포소개팅 순천소개팅 여수소개팅 군산소개팅 김제소개팅 남원소개팅 익산소개팅 전주소개팅 정읍소개팅 계룡소개팅 공주소개팅 논산소개팅 당진소개팅 보령소개팅 서산소개팅 아산소개팅 천안소개팅 제천소개팅 청주소개팅 충주소개팅.
        </p>
      </div>
    </footer>
  );
